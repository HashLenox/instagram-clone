<div x-data="{
...
}" class="grid w-20 h-screen p-3 overflow-x-hidden bg-white border-r menu text-base-content"
    :class="{ 'w-72 ': !shrink }">
    ...
    <div class="pt-3">
        ...
        <img x-cloak x-show="!(shrink ||drawer)" src="{{ asset('assets/images/logo.png') }}"
            class="h-16 text-black w-44" alt="logo">
    </div>

    {{-- Side content --}}
    <ul class="mt-2 space-y-4 text-black">
